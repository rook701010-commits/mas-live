...
export default function BossInfo({ bossName }) {
    return (_jsxs("div", { style: styles.wrap, children: [_jsx("span", { style: styles.label, children: "BOSS" }), _jsx("span", { style: styles.name, children: bossName })] }));
}
const styles = {
